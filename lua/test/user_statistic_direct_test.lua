...
describe("UserStatisticDirect", function()
  it("should direct-load-user_statistic", function()
    local setup = user_statistic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_statistic", setup.live and "live" or "unit")
...
function user_statistic_direct_setup(mockres)
