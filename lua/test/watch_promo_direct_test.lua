...
describe("WatchPromoDirect", function()
  it("should direct-list-watch_promo", function()
    local setup = watch_promo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-watch_promo", setup.live and "live" or "unit")
...
function watch_promo_direct_setup(mockres)
