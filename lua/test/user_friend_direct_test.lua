...
describe("UserFriendDirect", function()
  it("should direct-list-user_friend", function()
    local setup = user_friend_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_friend", setup.live and "live" or "unit")
...
function user_friend_direct_setup(mockres)
