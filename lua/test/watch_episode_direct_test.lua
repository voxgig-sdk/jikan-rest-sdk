...
describe("WatchEpisodeDirect", function()
  it("should direct-list-watch_episode", function()
    local setup = watch_episode_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-watch_episode", setup.live and "live" or "unit")
...
function watch_episode_direct_setup(mockres)
