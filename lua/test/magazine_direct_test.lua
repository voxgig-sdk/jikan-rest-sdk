...
describe("MagazineDirect", function()
  it("should direct-list-magazine", function()
    local setup = magazine_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-magazine", setup.live and "live" or "unit")
...
function magazine_direct_setup(mockres)
