...
describe("UserClubDirect", function()
  it("should direct-list-user_club", function()
    local setup = user_club_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_club", setup.live and "live" or "unit")
...
function user_club_direct_setup(mockres)
