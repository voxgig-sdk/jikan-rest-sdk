...
describe("PeopleSearchDirect", function()
  it("should direct-list-people_search", function()
    local setup = people_search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-people_search", setup.live and "live" or "unit")
...
function people_search_direct_setup(mockres)
