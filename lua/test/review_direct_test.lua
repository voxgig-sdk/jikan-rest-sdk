...
describe("ReviewDirect", function()
  it("should direct-load-review", function()
    local setup = review_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-review", setup.live and "live" or "unit")
...
function review_direct_setup(mockres)
