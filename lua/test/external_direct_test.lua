...
describe("ExternalDirect", function()
  it("should direct-list-external", function()
    local setup = external_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-external", setup.live and "live" or "unit")
...
function external_direct_setup(mockres)
