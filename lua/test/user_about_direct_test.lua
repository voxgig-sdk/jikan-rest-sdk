...
describe("UserAboutDirect", function()
  it("should direct-list-user_about", function()
    local setup = user_about_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_about", setup.live and "live" or "unit")
...
function user_about_direct_setup(mockres)
