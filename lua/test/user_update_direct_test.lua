...
describe("UserUpdateDirect", function()
  it("should direct-load-user_update", function()
    local setup = user_update_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_update", setup.live and "live" or "unit")
...
function user_update_direct_setup(mockres)
