...
describe("UserHistoryDirect", function()
  it("should direct-list-user_history", function()
    local setup = user_history_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_history", setup.live and "live" or "unit")
...
function user_history_direct_setup(mockres)
