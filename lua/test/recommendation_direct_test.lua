...
describe("RecommendationDirect", function()
  it("should direct-list-recommendation", function()
    local setup = recommendation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-recommendation", setup.live and "live" or "unit")
...
function recommendation_direct_setup(mockres)
