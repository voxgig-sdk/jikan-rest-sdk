...
describe("TopDirect", function()
  it("should direct-load-top", function()
    local setup = top_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-top", setup.live and "live" or "unit")
...
function top_direct_setup(mockres)
