...
local MangaEntity = {}
MangaEntity.__index = MangaEntity


function MangaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MangaEntity)
  self._name = "manga"
  self._client = client
...
function MangaEntity:get_name()
  return self._name
end


function MangaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MangaEntity.new(self._client, opts)
end
...
function MangaEntity:mark_deleted()
  self._deleted = true
end


function MangaEntity:deleted()
  return true == self._deleted
end


function MangaEntity:data_set(args)
  if args ~= nil then
...
function MangaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MangaEntity:match_set(args)
  if args ~= nil then
...
function MangaEntity:match_get()
...
function MangaEntity:stream(action, args, callopts)
...
---@param reqmatch MangaLoadMatch
---@param ctrl? table
---@return Manga
---@return string? err
function MangaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MangaListMatch
---@param ctrl? table
---@return Manga[]
---@return string? err
function MangaEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function MangaEntity:_run_op(ctx, post_done)
  local utility = self._utility
