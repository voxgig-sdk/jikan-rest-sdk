...
local RecommendationEntity = {}
RecommendationEntity.__index = RecommendationEntity


function RecommendationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RecommendationEntity)
...
function RecommendationEntity:get_name()
  return self._name
end


function RecommendationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RecommendationEntity.new(self._client, opts)
end
...
function RecommendationEntity:mark_deleted()
  self._deleted = true
end


function RecommendationEntity:deleted()
  return true == self._deleted
end


function RecommendationEntity:data_set(args)
  if args ~= nil then
...
function RecommendationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RecommendationEntity:match_set(args)
  if args ~= nil then
...
function RecommendationEntity:match_get()
...
function RecommendationEntity:stream(action, args, callopts)
...
function RecommendationEntity:_run_op(ctx, post_done)
  local utility = self._utility
