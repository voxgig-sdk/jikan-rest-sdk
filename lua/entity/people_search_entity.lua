...
local PeopleSearchEntity = {}
PeopleSearchEntity.__index = PeopleSearchEntity


function PeopleSearchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PeopleSearchEntity)
  self._name = "people_search"
  self._client = client
...
function PeopleSearchEntity:get_name()
  return self._name
end


function PeopleSearchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PeopleSearchEntity.new(self._client, opts)
end
...
function PeopleSearchEntity:mark_deleted()
  self._deleted = true
end


function PeopleSearchEntity:deleted()
  return true == self._deleted
end


function PeopleSearchEntity:data_set(args)
  if args ~= nil then
...
function PeopleSearchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PeopleSearchEntity:match_set(args)
  if args ~= nil then
...
function PeopleSearchEntity:match_get()
...
function PeopleSearchEntity:stream(action, args, callopts)
...
---@param reqmatch PeopleSearchListMatch
---@param ctrl? table
---@return PeopleSearch[]
---@return string? err
function PeopleSearchEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PeopleSearchEntity:_run_op(ctx, post_done)
  local utility = self._utility
