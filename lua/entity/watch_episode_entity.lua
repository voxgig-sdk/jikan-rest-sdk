...
local WatchEpisodeEntity = {}
WatchEpisodeEntity.__index = WatchEpisodeEntity


function WatchEpisodeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WatchEpisodeEntity)
  self._name = "watch_episode"
  self._client = client
...
function WatchEpisodeEntity:get_name()
  return self._name
end


function WatchEpisodeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WatchEpisodeEntity.new(self._client, opts)
end
...
function WatchEpisodeEntity:mark_deleted()
  self._deleted = true
end


function WatchEpisodeEntity:deleted()
  return true == self._deleted
end


function WatchEpisodeEntity:data_set(args)
  if args ~= nil then
...
function WatchEpisodeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WatchEpisodeEntity:match_set(args)
  if args ~= nil then
...
function WatchEpisodeEntity:match_get()
...
function WatchEpisodeEntity:stream(action, args, callopts)
...
function WatchEpisodeEntity:_run_op(ctx, post_done)
  local utility = self._utility
