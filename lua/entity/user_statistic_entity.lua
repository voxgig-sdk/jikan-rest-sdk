...
local UserStatisticEntity = {}
UserStatisticEntity.__index = UserStatisticEntity


function UserStatisticEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserStatisticEntity)
  self._name = "user_statistic"
  self._client = client
...
function UserStatisticEntity:get_name()
  return self._name
end


function UserStatisticEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserStatisticEntity.new(self._client, opts)
end
...
function UserStatisticEntity:mark_deleted()
  self._deleted = true
end


function UserStatisticEntity:deleted()
  return true == self._deleted
end


function UserStatisticEntity:data_set(args)
  if args ~= nil then
...
function UserStatisticEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserStatisticEntity:match_set(args)
  if args ~= nil then
...
function UserStatisticEntity:match_get()
...
function UserStatisticEntity:stream(action, args, callopts)
...
---@param reqmatch UserStatisticLoadMatch
---@param ctrl? table
---@return UserStatistic
---@return string? err
function UserStatisticEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UserStatisticEntity:_run_op(ctx, post_done)
  local utility = self._utility
