...
local UserUpdateEntity = {}
UserUpdateEntity.__index = UserUpdateEntity


function UserUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserUpdateEntity)
  self._name = "user_update"
  self._client = client
...
function UserUpdateEntity:get_name()
  return self._name
end


function UserUpdateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserUpdateEntity.new(self._client, opts)
end
...
function UserUpdateEntity:mark_deleted()
  self._deleted = true
end


function UserUpdateEntity:deleted()
  return true == self._deleted
end


function UserUpdateEntity:data_set(args)
  if args ~= nil then
...
function UserUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserUpdateEntity:match_set(args)
  if args ~= nil then
...
function UserUpdateEntity:match_get()
...
function UserUpdateEntity:stream(action, args, callopts)
...
---@param reqmatch UserUpdateLoadMatch
---@param ctrl? table
---@return UserUpdate
---@return string? err
function UserUpdateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UserUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
