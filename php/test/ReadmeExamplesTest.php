...
// JikanRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JikanRestSDK::test)
...
{
    private const SDK_CLASS = 'JikanRestSDK';
    ...
    private const SDK_BASE = 'jikanrest_sdk';
