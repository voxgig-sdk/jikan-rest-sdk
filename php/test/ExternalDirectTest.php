...
class ExternalDirectTest extends TestCase
{
    public function test_direct_list_external(): void
    {
        $setup = external_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-external", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
