...
class UserStatisticDirectTest extends TestCase
{
    public function test_direct_load_user_statistic(): void
    {
        $setup = user_statistic_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-user_statistic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
