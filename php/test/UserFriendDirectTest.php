...
class UserFriendDirectTest extends TestCase
{
    public function test_direct_list_user_friend(): void
    {
        $setup = user_friend_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-user_friend", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
