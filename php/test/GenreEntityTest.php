...
class GenreEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set JIKANREST_TEST_GENRE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function genre_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("JIKANREST_TEST_GENRE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["JIKANREST_TEST_GENRE_ENTID"]);
