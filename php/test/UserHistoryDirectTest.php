...
class UserHistoryDirectTest extends TestCase
{
    public function test_direct_list_user_history(): void
    {
        $setup = user_history_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-user_history", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
