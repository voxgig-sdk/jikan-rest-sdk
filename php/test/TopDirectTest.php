...
class TopDirectTest extends TestCase
{
    public function test_direct_load_top(): void
    {
        $setup = top_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-top", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
