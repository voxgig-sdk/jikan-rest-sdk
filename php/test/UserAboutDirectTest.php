...
class UserAboutDirectTest extends TestCase
{
    public function test_direct_list_user_about(): void
    {
        $setup = user_about_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-user_about", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
