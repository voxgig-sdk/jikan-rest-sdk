...
class RecommendationDirectTest extends TestCase
{
    public function test_direct_list_recommendation(): void
    {
        $setup = recommendation_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-recommendation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
