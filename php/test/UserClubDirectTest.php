...
class UserClubDirectTest extends TestCase
{
    public function test_direct_list_user_club(): void
    {
        $setup = user_club_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-user_club", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
