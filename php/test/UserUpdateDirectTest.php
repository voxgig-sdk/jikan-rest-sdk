...
class UserUpdateDirectTest extends TestCase
{
    public function test_direct_load_user_update(): void
    {
        $setup = user_update_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-user_update", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
