...
// JikanRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JikanRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JikanRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(JikanRestOmni::structfix($val, Struct::undef()))) {
