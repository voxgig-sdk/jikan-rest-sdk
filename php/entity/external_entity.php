...
class ExternalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExternalEntity($this->_client, $opts);
    }

    /**
     * @param External|array $args External data (assoc-array) to store.
     */
    ...
    /**
     * @return External|array The current External data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of External fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of External fields).
     */
    ...
    /**
     * List External items matching the given filter.
     *
     * @param ExternalListMatch|array|null $reqmatch Match filter (any subset
     *   of External fields) as an assoc-array; ExternalListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return External[]|array A list of External items as assoc-arrays at
