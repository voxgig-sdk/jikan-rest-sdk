...
// JikanRest SDK UserStatistic entity
...
class UserStatisticEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserStatisticEntity($this->_client, $opts);
    }

    /**
     * @param UserStatistic|array $args UserStatistic data (assoc-array) to store.
     */
    ...
    /**
     * @return UserStatistic|array The current UserStatistic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserStatistic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserStatistic fields).
     */
    ...
    /**
     * Load a single UserStatistic.
     *
     * @param UserStatisticLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserStatisticLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserStatistic|array The loaded UserStatistic as an assoc-array at the
