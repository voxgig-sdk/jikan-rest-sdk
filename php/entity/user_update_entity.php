...
// JikanRest SDK UserUpdate entity
...
class UserUpdateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserUpdateEntity($this->_client, $opts);
    }

    /**
     * @param UserUpdate|array $args UserUpdate data (assoc-array) to store.
     */
    ...
    /**
     * @return UserUpdate|array The current UserUpdate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserUpdate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserUpdate fields).
     */
    ...
    /**
     * Load a single UserUpdate.
     *
     * @param UserUpdateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserUpdateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserUpdate|array The loaded UserUpdate as an assoc-array at the
