...
// JikanRest SDK UserHistory entity
...
class UserHistoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserHistoryEntity($this->_client, $opts);
    }

    /**
     * @param UserHistory|array $args UserHistory data (assoc-array) to store.
     */
    ...
    /**
     * @return UserHistory|array The current UserHistory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserHistory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserHistory fields).
     */
    ...
    /**
     * List UserHistory items matching the given filter.
     *
     * @param UserHistoryListMatch|array|null $reqmatch Match filter (any subset
     *   of UserHistory fields) as an assoc-array; UserHistoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserHistory[]|array A list of UserHistory items as assoc-arrays at
