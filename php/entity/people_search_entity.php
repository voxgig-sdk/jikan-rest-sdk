...
// JikanRest SDK PeopleSearch entity
...
class PeopleSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PeopleSearchEntity($this->_client, $opts);
    }

    /**
     * @param PeopleSearch|array $args PeopleSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return PeopleSearch|array The current PeopleSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PeopleSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PeopleSearch fields).
     */
    ...
    /**
     * List PeopleSearch items matching the given filter.
     *
     * @param PeopleSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of PeopleSearch fields) as an assoc-array; PeopleSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PeopleSearch[]|array A list of PeopleSearch items as assoc-arrays at
