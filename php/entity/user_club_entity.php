...
class UserClubEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserClubEntity($this->_client, $opts);
    }

    /**
     * @param UserClub|array $args UserClub data (assoc-array) to store.
     */
    ...
    /**
     * @return UserClub|array The current UserClub data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserClub fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserClub fields).
     */
    ...
    /**
     * List UserClub items matching the given filter.
     *
     * @param UserClubListMatch|array|null $reqmatch Match filter (any subset
     *   of UserClub fields) as an assoc-array; UserClubListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserClub[]|array A list of UserClub items as assoc-arrays at
