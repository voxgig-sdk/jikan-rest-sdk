...
class TopEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TopEntity($this->_client, $opts);
    }

    /**
     * @param Top|array $args Top data (assoc-array) to store.
     */
    ...
    /**
     * @return Top|array The current Top data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Top fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Top fields).
     */
     ...
     * Load a single Top.
     *
     * @param TopLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TopLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Top|array The loaded Top as an assoc-array at the
