...
// JikanRest SDK UserFriend entity
...
class UserFriendEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserFriendEntity($this->_client, $opts);
    }

    /**
     * @param UserFriend|array $args UserFriend data (assoc-array) to store.
     */
    ...
    /**
     * @return UserFriend|array The current UserFriend data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserFriend fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserFriend fields).
     */
    ...
    /**
     * List UserFriend items matching the given filter.
     *
     * @param UserFriendListMatch|array|null $reqmatch Match filter (any subset
     *   of UserFriend fields) as an assoc-array; UserFriendListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserFriend[]|array A list of UserFriend items as assoc-arrays at
