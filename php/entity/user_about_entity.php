...
// JikanRest SDK UserAbout entity
...
class UserAboutEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserAboutEntity($this->_client, $opts);
    }

    /**
     * @param UserAbout|array $args UserAbout data (assoc-array) to store.
     */
    ...
    /**
     * @return UserAbout|array The current UserAbout data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserAbout fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserAbout fields).
     */
     ...
     *
     * @param UserAboutListMatch|array|null $reqmatch Match filter (any subset
     *   of UserAbout fields) as an assoc-array; UserAboutListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserAbout[]|array A list of UserAbout items as assoc-arrays at
