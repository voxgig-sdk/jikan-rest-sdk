...
class JikanRestRbacFeature extends JikanRestBaseFeature
{
    ...
    private function _required(JikanRestContext $ctx): ?string
    {
    ...
    private function _reject(JikanRestContext $ctx, string $required): void
    {
    ...
    private function _track(JikanRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
