...
class JikanRestTimeoutFeature extends JikanRestBaseFeature
{
    ...
    private function _with_timeout(JikanRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JikanRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
