...
// JikanRest SDK ratelimit feature
...
class JikanRestRatelimitFeature extends JikanRestBaseFeature
{
    ...
    private function _acquire(JikanRestContext $ctx): void
    {
    ...
    private function _track(JikanRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
