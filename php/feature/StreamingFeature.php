...
// JikanRest SDK streaming feature
...
class JikanRestStreamingFeature extends JikanRestBaseFeature
{
    ...
    private function _iterate(JikanRestResult $result): \Generator
    {
    ...
    private function _streamable(JikanRestContext $ctx): bool
    {
