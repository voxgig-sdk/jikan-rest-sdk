...
class JikanRestProxyFeature extends JikanRestBaseFeature
{
    ...
    public function init(JikanRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JikanRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
