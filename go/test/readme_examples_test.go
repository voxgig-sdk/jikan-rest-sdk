...
const testSeed = `map[string]any{"entity": map[string]any{"anime": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "club": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "external": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "genre": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "magazine": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "manga": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "people_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "producer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recommendation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "review": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "season": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "top": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_about": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_club": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_friend": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_statistic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_update": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "watch_episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "watch_promo": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
