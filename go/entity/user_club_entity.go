...
func NewUserClubEntity(client *core.JikanRestSDK, entopts map[string]any) *UserClubEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserClubEntity) GetName() string { return e.name }
...
func (e *UserClubEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserClubEntity) Deleted() bool {
	return e.deleted
}


func (e *UserClubEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserClubEntity(e.client, opts)
}

func (e *UserClubEntity) Data(args ...any) any {
...
func (e *UserClubEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *UserClubEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserClubEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *UserClubEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserClubEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserClubEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserClubEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
