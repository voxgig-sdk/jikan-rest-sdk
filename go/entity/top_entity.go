...
func NewTopEntity(client *core.JikanRestSDK, entopts map[string]any) *TopEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TopEntity) GetName() string { return e.name }
...
func (e *TopEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TopEntity) Deleted() bool {
	return e.deleted
}


func (e *TopEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTopEntity(e.client, opts)
}

func (e *TopEntity) Data(args ...any) any {
...
func (e *TopEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Top; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TopEntity) DataTyped(data ...Top) Top {
	if len(data) > 0 {
		return typedFrom[Top](e.Data(asMap(data[0])))
	}
	return typedFrom[Top](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Top (all fields
// optional at the wire level).
func (e *TopEntity) MatchTyped(match ...Top) Top {
	if len(match) > 0 {
		return typedFrom[Top](e.Match(asMap(match[0])))
	}
	return typedFrom[Top](e.Match())
}
...
func (e *TopEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TopEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TopLoadMatch and returns an Top. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TopEntity) LoadTyped(reqmatch TopLoadMatch, ctrl map[string]any) (Top, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Top{}, err
	}
	return typedFrom[Top](res), nil
}



func (e *TopEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TopEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TopEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TopEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TopEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
