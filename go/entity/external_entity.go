...
func NewExternalEntity(client *core.JikanRestSDK, entopts map[string]any) *ExternalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExternalEntity) GetName() string { return e.name }
...
func (e *ExternalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExternalEntity) Deleted() bool {
	return e.deleted
}


func (e *ExternalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExternalEntity(e.client, opts)
}

func (e *ExternalEntity) Data(args ...any) any {
...
func (e *ExternalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an External; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExternalEntity) DataTyped(data ...External) External {
	if len(data) > 0 {
		return typedFrom[External](e.Data(asMap(data[0])))
	}
	return typedFrom[External](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through External (all fields
// optional at the wire level).
func (e *ExternalEntity) MatchTyped(match ...External) External {
	if len(match) > 0 {
		return typedFrom[External](e.Match(asMap(match[0])))
	}
	return typedFrom[External](e.Match())
}
...
func (e *ExternalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExternalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ExternalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExternalListMatch and returns []External. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ExternalEntity) ListTyped(reqmatch ExternalListMatch, ctrl map[string]any) ([]External, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[External](res), nil
}



func (e *ExternalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExternalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExternalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExternalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
