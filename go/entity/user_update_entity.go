...
func NewUserUpdateEntity(client *core.JikanRestSDK, entopts map[string]any) *UserUpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserUpdateEntity) GetName() string { return e.name }
...
func (e *UserUpdateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserUpdateEntity) Deleted() bool {
	return e.deleted
}


func (e *UserUpdateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserUpdateEntity(e.client, opts)
}

func (e *UserUpdateEntity) Data(args ...any) any {
...
func (e *UserUpdateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserUpdate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserUpdateEntity) DataTyped(data ...UserUpdate) UserUpdate {
	if len(data) > 0 {
		return typedFrom[UserUpdate](e.Data(asMap(data[0])))
	}
	return typedFrom[UserUpdate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserUpdate (all fields
// optional at the wire level).
func (e *UserUpdateEntity) MatchTyped(match ...UserUpdate) UserUpdate {
	if len(match) > 0 {
		return typedFrom[UserUpdate](e.Match(asMap(match[0])))
	}
	return typedFrom[UserUpdate](e.Match())
}
...
func (e *UserUpdateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserUpdateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserUpdateLoadMatch and returns an UserUpdate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserUpdateEntity) LoadTyped(reqmatch UserUpdateLoadMatch, ctrl map[string]any) (UserUpdate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserUpdate{}, err
	}
	return typedFrom[UserUpdate](res), nil
}



func (e *UserUpdateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserUpdateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserUpdateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserUpdateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserUpdateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
