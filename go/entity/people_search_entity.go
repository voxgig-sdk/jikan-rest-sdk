...
type PeopleSearchEntity struct {
	name    string
...
func NewPeopleSearchEntity(client *core.JikanRestSDK, entopts map[string]any) *PeopleSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PeopleSearchEntity) GetName() string { return e.name }
...
func (e *PeopleSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PeopleSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *PeopleSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPeopleSearchEntity(e.client, opts)
}

func (e *PeopleSearchEntity) Data(args ...any) any {
...
func (e *PeopleSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PeopleSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PeopleSearchEntity) DataTyped(data ...PeopleSearch) PeopleSearch {
	if len(data) > 0 {
		return typedFrom[PeopleSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[PeopleSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PeopleSearch (all fields
// optional at the wire level).
func (e *PeopleSearchEntity) MatchTyped(match ...PeopleSearch) PeopleSearch {
	if len(match) > 0 {
		return typedFrom[PeopleSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[PeopleSearch](e.Match())
}
...
func (e *PeopleSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PeopleSearchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PeopleSearchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PeopleSearchListMatch and returns []PeopleSearch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PeopleSearchEntity) ListTyped(reqmatch PeopleSearchListMatch, ctrl map[string]any) ([]PeopleSearch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PeopleSearch](res), nil
}



func (e *PeopleSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PeopleSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PeopleSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PeopleSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
