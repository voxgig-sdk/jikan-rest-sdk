...
func NewClubEntity(client *core.JikanRestSDK, entopts map[string]any) *ClubEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClubEntity) GetName() string { return e.name }
...
func (e *ClubEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClubEntity) Deleted() bool {
	return e.deleted
}


func (e *ClubEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClubEntity(e.client, opts)
}

func (e *ClubEntity) Data(args ...any) any {
...
func (e *ClubEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Club; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClubEntity) DataTyped(data ...Club) Club {
	if len(data) > 0 {
		return typedFrom[Club](e.Data(asMap(data[0])))
	}
	return typedFrom[Club](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Club (all fields
// optional at the wire level).
func (e *ClubEntity) MatchTyped(match ...Club) Club {
	if len(match) > 0 {
		return typedFrom[Club](e.Match(asMap(match[0])))
	}
	return typedFrom[Club](e.Match())
}
...
func (e *ClubEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClubEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClubLoadMatch and returns an Club. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ClubEntity) LoadTyped(reqmatch ClubLoadMatch, ctrl map[string]any) (Club, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Club{}, err
	}
	return typedFrom[Club](res), nil
}




func (e *ClubEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ClubListMatch and returns []Club. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ClubEntity) ListTyped(reqmatch ClubListMatch, ctrl map[string]any) ([]Club, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Club](res), nil
}



func (e *ClubEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClubEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClubEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClubEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
