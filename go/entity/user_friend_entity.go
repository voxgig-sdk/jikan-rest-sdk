...
func NewUserFriendEntity(client *core.JikanRestSDK, entopts map[string]any) *UserFriendEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserFriendEntity) GetName() string { return e.name }
...
func (e *UserFriendEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserFriendEntity) Deleted() bool {
	return e.deleted
}


func (e *UserFriendEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserFriendEntity(e.client, opts)
}

func (e *UserFriendEntity) Data(args ...any) any {
...
func (e *UserFriendEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserFriend; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserFriendEntity) DataTyped(data ...UserFriend) UserFriend {
	if len(data) > 0 {
		return typedFrom[UserFriend](e.Data(asMap(data[0])))
	}
	return typedFrom[UserFriend](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserFriend (all fields
// optional at the wire level).
func (e *UserFriendEntity) MatchTyped(match ...UserFriend) UserFriend {
	if len(match) > 0 {
		return typedFrom[UserFriend](e.Match(asMap(match[0])))
	}
	return typedFrom[UserFriend](e.Match())
}
...
func (e *UserFriendEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserFriendEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UserFriendEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserFriendListMatch and returns []UserFriend. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UserFriendEntity) ListTyped(reqmatch UserFriendListMatch, ctrl map[string]any) ([]UserFriend, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[UserFriend](res), nil
}



func (e *UserFriendEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserFriendEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserFriendEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserFriendEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
