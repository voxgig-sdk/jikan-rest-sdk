...
func NewMagazineEntity(client *core.JikanRestSDK, entopts map[string]any) *MagazineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MagazineEntity) GetName() string { return e.name }
...
func (e *MagazineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MagazineEntity) Deleted() bool {
	return e.deleted
}


func (e *MagazineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMagazineEntity(e.client, opts)
}

func (e *MagazineEntity) Data(args ...any) any {
...
func (e *MagazineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Magazine; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MagazineEntity) DataTyped(data ...Magazine) Magazine {
	if len(data) > 0 {
		return typedFrom[Magazine](e.Data(asMap(data[0])))
	}
	return typedFrom[Magazine](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Magazine (all fields
// optional at the wire level).
func (e *MagazineEntity) MatchTyped(match ...Magazine) Magazine {
	if len(match) > 0 {
		return typedFrom[Magazine](e.Match(asMap(match[0])))
	}
	return typedFrom[Magazine](e.Match())
}
...
func (e *MagazineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MagazineEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MagazineEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MagazineListMatch and returns []Magazine. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MagazineEntity) ListTyped(reqmatch MagazineListMatch, ctrl map[string]any) ([]Magazine, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Magazine](res), nil
}



func (e *MagazineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MagazineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MagazineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MagazineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
