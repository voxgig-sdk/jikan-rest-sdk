...
func NewWatchPromoEntity(client *core.JikanRestSDK, entopts map[string]any) *WatchPromoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WatchPromoEntity) GetName() string { return e.name }
...
func (e *WatchPromoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WatchPromoEntity) Deleted() bool {
	return e.deleted
}


func (e *WatchPromoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWatchPromoEntity(e.client, opts)
}

func (e *WatchPromoEntity) Data(args ...any) any {
...
func (e *WatchPromoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WatchPromo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WatchPromoEntity) DataTyped(data ...WatchPromo) WatchPromo {
	if len(data) > 0 {
		return typedFrom[WatchPromo](e.Data(asMap(data[0])))
	}
	return typedFrom[WatchPromo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WatchPromo (all fields
// optional at the wire level).
func (e *WatchPromoEntity) MatchTyped(match ...WatchPromo) WatchPromo {
	if len(match) > 0 {
		return typedFrom[WatchPromo](e.Match(asMap(match[0])))
	}
	return typedFrom[WatchPromo](e.Match())
}
...
func (e *WatchPromoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WatchPromoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WatchPromoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WatchPromoListMatch and returns []WatchPromo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WatchPromoEntity) ListTyped(reqmatch WatchPromoListMatch, ctrl map[string]any) ([]WatchPromo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WatchPromo](res), nil
}



func (e *WatchPromoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WatchPromoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WatchPromoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WatchPromoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
