...
func NewProducerEntity(client *core.JikanRestSDK, entopts map[string]any) *ProducerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProducerEntity) GetName() string { return e.name }
...
func (e *ProducerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProducerEntity) Deleted() bool {
	return e.deleted
}


func (e *ProducerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProducerEntity(e.client, opts)
}

func (e *ProducerEntity) Data(args ...any) any {
...
func (e *ProducerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Producer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProducerEntity) DataTyped(data ...Producer) Producer {
	if len(data) > 0 {
		return typedFrom[Producer](e.Data(asMap(data[0])))
	}
	return typedFrom[Producer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Producer (all fields
// optional at the wire level).
func (e *ProducerEntity) MatchTyped(match ...Producer) Producer {
	if len(match) > 0 {
		return typedFrom[Producer](e.Match(asMap(match[0])))
	}
	return typedFrom[Producer](e.Match())
}
...
func (e *ProducerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProducerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProducerLoadMatch and returns an Producer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProducerEntity) LoadTyped(reqmatch ProducerLoadMatch, ctrl map[string]any) (Producer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Producer{}, err
	}
	return typedFrom[Producer](res), nil
}




func (e *ProducerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ProducerListMatch and returns []Producer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProducerEntity) ListTyped(reqmatch ProducerListMatch, ctrl map[string]any) ([]Producer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Producer](res), nil
}



func (e *ProducerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProducerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProducerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProducerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
