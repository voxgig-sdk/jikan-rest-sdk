...
func NewUserHistoryEntity(client *core.JikanRestSDK, entopts map[string]any) *UserHistoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserHistoryEntity) GetName() string { return e.name }
...
func (e *UserHistoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserHistoryEntity) Deleted() bool {
	return e.deleted
}


func (e *UserHistoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserHistoryEntity(e.client, opts)
}

func (e *UserHistoryEntity) Data(args ...any) any {
...
func (e *UserHistoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserHistory; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserHistoryEntity) DataTyped(data ...UserHistory) UserHistory {
	if len(data) > 0 {
		return typedFrom[UserHistory](e.Data(asMap(data[0])))
	}
	return typedFrom[UserHistory](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserHistory (all fields
// optional at the wire level).
func (e *UserHistoryEntity) MatchTyped(match ...UserHistory) UserHistory {
	if len(match) > 0 {
		return typedFrom[UserHistory](e.Match(asMap(match[0])))
	}
	return typedFrom[UserHistory](e.Match())
}
...
func (e *UserHistoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserHistoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UserHistoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserHistoryListMatch and returns []UserHistory. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UserHistoryEntity) ListTyped(reqmatch UserHistoryListMatch, ctrl map[string]any) ([]UserHistory, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[UserHistory](res), nil
}



func (e *UserHistoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserHistoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserHistoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserHistoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
