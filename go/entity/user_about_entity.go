...
func NewUserAboutEntity(client *core.JikanRestSDK, entopts map[string]any) *UserAboutEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserAboutEntity) GetName() string { return e.name }
...
func (e *UserAboutEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserAboutEntity) Deleted() bool {
	return e.deleted
}


func (e *UserAboutEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserAboutEntity(e.client, opts)
}

func (e *UserAboutEntity) Data(args ...any) any {
...
func (e *UserAboutEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserAbout; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserAboutEntity) DataTyped(data ...UserAbout) UserAbout {
	if len(data) > 0 {
		return typedFrom[UserAbout](e.Data(asMap(data[0])))
	}
	return typedFrom[UserAbout](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserAbout (all fields
// optional at the wire level).
func (e *UserAboutEntity) MatchTyped(match ...UserAbout) UserAbout {
	if len(match) > 0 {
		return typedFrom[UserAbout](e.Match(asMap(match[0])))
	}
	return typedFrom[UserAbout](e.Match())
}
...
func (e *UserAboutEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserAboutEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UserAboutEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserAboutListMatch and returns []UserAbout. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UserAboutEntity) ListTyped(reqmatch UserAboutListMatch, ctrl map[string]any) ([]UserAbout, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[UserAbout](res), nil
}



func (e *UserAboutEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserAboutEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserAboutEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserAboutEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
