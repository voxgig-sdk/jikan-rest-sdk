...
type UserStatisticEntity struct {
	name    string
...
func NewUserStatisticEntity(client *core.JikanRestSDK, entopts map[string]any) *UserStatisticEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserStatisticEntity) GetName() string { return e.name }
...
func (e *UserStatisticEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserStatisticEntity) Deleted() bool {
	return e.deleted
}


func (e *UserStatisticEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserStatisticEntity(e.client, opts)
}

func (e *UserStatisticEntity) Data(args ...any) any {
...
func (e *UserStatisticEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserStatistic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserStatisticEntity) DataTyped(data ...UserStatistic) UserStatistic {
	if len(data) > 0 {
		return typedFrom[UserStatistic](e.Data(asMap(data[0])))
	}
	return typedFrom[UserStatistic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserStatistic (all fields
// optional at the wire level).
func (e *UserStatisticEntity) MatchTyped(match ...UserStatistic) UserStatistic {
	if len(match) > 0 {
		return typedFrom[UserStatistic](e.Match(asMap(match[0])))
	}
	return typedFrom[UserStatistic](e.Match())
}
...
func (e *UserStatisticEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserStatisticEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserStatisticLoadMatch and returns an UserStatistic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserStatisticEntity) LoadTyped(reqmatch UserStatisticLoadMatch, ctrl map[string]any) (UserStatistic, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserStatistic{}, err
	}
	return typedFrom[UserStatistic](res), nil
}



func (e *UserStatisticEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserStatisticEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserStatisticEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserStatisticEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserStatisticEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
