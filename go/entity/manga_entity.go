...
func NewMangaEntity(client *core.JikanRestSDK, entopts map[string]any) *MangaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MangaEntity) GetName() string { return e.name }
...
func (e *MangaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MangaEntity) Deleted() bool {
	return e.deleted
}


func (e *MangaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMangaEntity(e.client, opts)
}

func (e *MangaEntity) Data(args ...any) any {
...
func (e *MangaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Manga; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MangaEntity) DataTyped(data ...Manga) Manga {
	if len(data) > 0 {
		return typedFrom[Manga](e.Data(asMap(data[0])))
	}
	return typedFrom[Manga](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Manga (all fields
// optional at the wire level).
func (e *MangaEntity) MatchTyped(match ...Manga) Manga {
	if len(match) > 0 {
		return typedFrom[Manga](e.Match(asMap(match[0])))
	}
	return typedFrom[Manga](e.Match())
}
...
func (e *MangaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MangaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MangaLoadMatch and returns an Manga. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MangaEntity) LoadTyped(reqmatch MangaLoadMatch, ctrl map[string]any) (Manga, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Manga{}, err
	}
	return typedFrom[Manga](res), nil
}




func (e *MangaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MangaListMatch and returns []Manga. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MangaEntity) ListTyped(reqmatch MangaListMatch, ctrl map[string]any) ([]Manga, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Manga](res), nil
}



func (e *MangaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MangaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MangaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MangaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
