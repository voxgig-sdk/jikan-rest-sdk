...
func NewReviewEntity(client *core.JikanRestSDK, entopts map[string]any) *ReviewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReviewEntity) GetName() string { return e.name }
...
func (e *ReviewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReviewEntity) Deleted() bool {
	return e.deleted
}


func (e *ReviewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReviewEntity(e.client, opts)
}

func (e *ReviewEntity) Data(args ...any) any {
...
func (e *ReviewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Review; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReviewEntity) DataTyped(data ...Review) Review {
	if len(data) > 0 {
		return typedFrom[Review](e.Data(asMap(data[0])))
	}
	return typedFrom[Review](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Review (all fields
// optional at the wire level).
func (e *ReviewEntity) MatchTyped(match ...Review) Review {
	if len(match) > 0 {
		return typedFrom[Review](e.Match(asMap(match[0])))
	}
	return typedFrom[Review](e.Match())
}
...
func (e *ReviewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReviewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReviewLoadMatch and returns an Review. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReviewEntity) LoadTyped(reqmatch ReviewLoadMatch, ctrl map[string]any) (Review, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Review{}, err
	}
	return typedFrom[Review](res), nil
}



func (e *ReviewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReviewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReviewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReviewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReviewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
