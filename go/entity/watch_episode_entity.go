...
type WatchEpisodeEntity struct {
	name    string
...
func NewWatchEpisodeEntity(client *core.JikanRestSDK, entopts map[string]any) *WatchEpisodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WatchEpisodeEntity) GetName() string { return e.name }
...
func (e *WatchEpisodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WatchEpisodeEntity) Deleted() bool {
	return e.deleted
}


func (e *WatchEpisodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWatchEpisodeEntity(e.client, opts)
}

func (e *WatchEpisodeEntity) Data(args ...any) any {
...
func (e *WatchEpisodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WatchEpisode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WatchEpisodeEntity) DataTyped(data ...WatchEpisode) WatchEpisode {
	if len(data) > 0 {
		return typedFrom[WatchEpisode](e.Data(asMap(data[0])))
	}
	return typedFrom[WatchEpisode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WatchEpisode (all fields
// optional at the wire level).
func (e *WatchEpisodeEntity) MatchTyped(match ...WatchEpisode) WatchEpisode {
	if len(match) > 0 {
		return typedFrom[WatchEpisode](e.Match(asMap(match[0])))
	}
	return typedFrom[WatchEpisode](e.Match())
}
...
func (e *WatchEpisodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WatchEpisodeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WatchEpisodeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WatchEpisodeListMatch and returns []WatchEpisode. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WatchEpisodeEntity) ListTyped(reqmatch WatchEpisodeListMatch, ctrl map[string]any) ([]WatchEpisode, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WatchEpisode](res), nil
}



func (e *WatchEpisodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WatchEpisodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WatchEpisodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WatchEpisodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
