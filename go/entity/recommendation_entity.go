...
func NewRecommendationEntity(client *core.JikanRestSDK, entopts map[string]any) *RecommendationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecommendationEntity) GetName() string { return e.name }
...
func (e *RecommendationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecommendationEntity) Deleted() bool {
	return e.deleted
}


func (e *RecommendationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecommendationEntity(e.client, opts)
}

func (e *RecommendationEntity) Data(args ...any) any {
...
func (e *RecommendationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Recommendation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecommendationEntity) DataTyped(data ...Recommendation) Recommendation {
	if len(data) > 0 {
		return typedFrom[Recommendation](e.Data(asMap(data[0])))
	}
	return typedFrom[Recommendation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Recommendation (all fields
// optional at the wire level).
func (e *RecommendationEntity) MatchTyped(match ...Recommendation) Recommendation {
	if len(match) > 0 {
		return typedFrom[Recommendation](e.Match(asMap(match[0])))
	}
	return typedFrom[Recommendation](e.Match())
}
...
func (e *RecommendationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecommendationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RecommendationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecommendationListMatch and returns []Recommendation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RecommendationEntity) ListTyped(reqmatch RecommendationListMatch, ctrl map[string]any) ([]Recommendation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Recommendation](res), nil
}



func (e *RecommendationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecommendationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecommendationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecommendationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
