...
import (
	...
	"github.com/voxgig-sdk/jikan-rest-sdk/go/entity"
	"github.com/voxgig-sdk/jikan-rest-sdk/go/feature"
	_ "github.com/voxgig-sdk/jikan-rest-sdk/go/utility"
)
...
// instead of `sdk.NewJikanRestSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *JikanRestSDK  { return NewJikanRestSDK(nil) }
func Test() *JikanRestSDK { return TestSDK(nil, nil) }
