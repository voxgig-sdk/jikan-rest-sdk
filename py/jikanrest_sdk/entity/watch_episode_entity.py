...
class WatchEpisodeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WatchEpisodeEntity(self._client, opts)
    ...
    def data_get(self) -> WatchEpisode:
    ...
    def match_get(self) -> WatchEpisode:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WatchEpisode]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WatchEpisode().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
