...
class UserHistoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserHistoryEntity(self._client, opts)
    ...
    def match_get(self) -> UserHistory:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[UserHistory]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.UserHistory().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
