...
class PeopleSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PeopleSearchEntity(self._client, opts)
    ...
    def data_get(self) -> PeopleSearch:
    ...
    def match_get(self) -> PeopleSearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PeopleSearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PeopleSearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
