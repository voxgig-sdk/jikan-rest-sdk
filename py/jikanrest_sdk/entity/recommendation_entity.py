...
class RecommendationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RecommendationEntity(self._client, opts)
    ...
    def data_get(self) -> Recommendation:
    ...
    def match_get(self) -> Recommendation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Recommendation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Recommendation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
