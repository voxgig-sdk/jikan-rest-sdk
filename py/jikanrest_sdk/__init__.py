...
from jikanrest_sdk.utility import register

# Load features
from jikanrest_sdk.feature.base_feature import JikanRestBaseFeature
from jikanrest_sdk.features import _has_feature, _make_feature
...
class JikanRestSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JikanRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Anime(self, data=None) -> "AnimeEntity":
        ...
        from jikanrest_sdk.entity.anime_entity import AnimeEntity
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from jikanrest_sdk.entity.character_entity import CharacterEntity
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from jikanrest_sdk.entity.person_entity import PersonEntity
    ...
    def Producer(self, data=None) -> "ProducerEntity":
        ...
        from jikanrest_sdk.entity.producer_entity import ProducerEntity
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from jikanrest_sdk.entity.random_entity import RandomEntity
    ...
    def Recommendation(self, data=None) -> "RecommendationEntity":
        ...
        from jikanrest_sdk.entity.recommendation_entity import RecommendationEntity
    ...
    def Review(self, data=None) -> "ReviewEntity":
        ...
        from jikanrest_sdk.entity.review_entity import ReviewEntity
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from jikanrest_sdk.entity.schedule_entity import ScheduleEntity
    ...
    def WatchPromo(self, data=None) -> "WatchPromoEntity":
        ...
        from jikanrest_sdk.entity.watch_promo_entity import WatchPromoEntity
        return WatchPromoEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "JikanRestSDK":
        if sdkopts is None:
            sdkopts = {}
