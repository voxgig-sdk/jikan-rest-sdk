...
class JikanRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JikanRestTestRunner.getenv("JIKANREST_TEST_LIVE")
        override = JikanRestTestRunner.getenv("JIKANREST_TEST_OVERRIDE")
        ...
        explain = JikanRestTestRunner.getenv("JIKANREST_TEST_EXPLAIN")
