...
class JikanRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JikanRestTestRunner.getenv("JIKAN_REST_TEST_LIVE")
        override = JikanRestTestRunner.getenv("JIKAN_REST_TEST_OVERRIDE")
        ...
        explain = JikanRestTestRunner.getenv("JIKAN_REST_TEST_EXPLAIN")
