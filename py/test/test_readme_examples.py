# JikanRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JikanRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JikanRestSDK(...) and JikanRestSDK.test(...) become
#      JikanRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jikanrest_sdk"
_SDK_CLASS = "JikanRestSDK"
