...
exports.UserClubEntity = void 0;
const JikanRestEntityBase_1 = require("../JikanRestEntityBase");
// TODO: needs Entity superclass
class UserClubEntity extends JikanRestEntityBase_1.JikanRestEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'user_club';
        this.name_ = 'user_club';
        this.Name = 'UserClub';
    }
    make() {
        return new UserClubEntity(this._client, this.entopts());
    }
...
exports.UserClubEntity = UserClubEntity;
//# sourceMappingURL=UserClubEntity.js.map