...
class UserAboutEntity extends JikanRestEntityBase_1.JikanRestEntityBase {
    constructor(client, entopts) {
        ...
        this.name_ = 'user_about';
        this.Name = 'UserAbout';
    }
    make() {
        return new UserAboutEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<UserAbout[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.UserAboutEntity = UserAboutEntity;
//# sourceMappingURL=UserAboutEntity.js.map