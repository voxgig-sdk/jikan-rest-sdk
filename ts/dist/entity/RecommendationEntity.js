...
class RecommendationEntity extends JikanRestEntityBase_1.JikanRestEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'recommendation';
        this.name_ = 'recommendation';
        this.Name = 'Recommendation';
    }
    make() {
        return new RecommendationEntity(this._client, this.entopts());
    }
...
//# sourceMappingURL=RecommendationEntity.js.map