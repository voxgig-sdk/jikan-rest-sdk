...
exports.UserStatisticEntity = void 0;
const JikanRestEntityBase_1 = require("../JikanRestEntityBase");
// TODO: needs Entity superclass
class UserStatisticEntity extends JikanRestEntityBase_1.JikanRestEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'user_statistic';
        this.name_ = 'user_statistic';
        this.Name = 'UserStatistic';
    }
    make() {
        return new UserStatisticEntity(this._client, this.entopts());
    }
...
exports.UserStatisticEntity = UserStatisticEntity;
//# sourceMappingURL=UserStatisticEntity.js.map