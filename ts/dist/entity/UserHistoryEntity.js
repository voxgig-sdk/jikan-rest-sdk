...
class UserHistoryEntity extends JikanRestEntityBase_1.JikanRestEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'user_history';
        this.name_ = 'user_history';
        this.Name = 'UserHistory';
    }
    make() {
        return new UserHistoryEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<UserHistory[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=UserHistoryEntity.js.map