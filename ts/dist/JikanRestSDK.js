...
exports.SDK = exports.JikanRestSDK = exports.JikanRestEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
const ProducerEntity_1 = require("./entity/ProducerEntity");
const RandomEntity_1 = require("./entity/RandomEntity");
const RecommendationEntity_1 = require("./entity/RecommendationEntity");
...
const TopEntity_1 = require("./entity/TopEntity");
...
const WatchPromoEntity_1 = require("./entity/WatchPromoEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const JikanRestEntityBase_1 = require("./JikanRestEntityBase");
Object.defineProperty(exports, "JikanRestEntityBase", { enumerable: true, get: function () { return JikanRestEntityBase_1.JikanRestEntityBase; } });
...
class JikanRestSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('JikanRestSDK: graphql: ' +
    ...
    Club(entopts) {
        const self = this;
        return new ClubEntity_1.ClubEntity(self, entopts);
    }
    ...
    External(entopts) {
        const self = this;
        return new ExternalEntity_1.ExternalEntity(self, entopts);
    }
    ...
    Magazine(entopts) {
        const self = this;
        return new MagazineEntity_1.MagazineEntity(self, entopts);
    }
    ...
    Manga(entopts) {
        const self = this;
        return new MangaEntity_1.MangaEntity(self, entopts);
    }
    // Entity access: `client.PeopleSearch().list()` / `client.PeopleSearch().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    PeopleSearch(entopts) {
        const self = this;
        return new PeopleSearchEntity_1.PeopleSearchEntity(self, entopts);
    }
    ...
    Producer(entopts) {
        const self = this;
        return new ProducerEntity_1.ProducerEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    Recommendation(entopts) {
        const self = this;
        return new RecommendationEntity_1.RecommendationEntity(self, entopts);
    }
    ...
    Top(entopts) {
        const self = this;
        return new TopEntity_1.TopEntity(self, entopts);
    }
    ...
    UserAbout(entopts) {
        const self = this;
        return new UserAboutEntity_1.UserAboutEntity(self, entopts);
    }
    ...
    UserClub(entopts) {
        const self = this;
        return new UserClubEntity_1.UserClubEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    UserStatistic(entopts) {
        const self = this;
        return new UserStatisticEntity_1.UserStatisticEntity(self, entopts);
    }
    ...
    UserUpdate(entopts) {
        const self = this;
        return new UserUpdateEntity_1.UserUpdateEntity(self, entopts);
    }
    // Entity access: `client.WatchEpisode().list()` / `client.WatchEpisode().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WatchEpisode(entopts) {
        const self = this;
        return new WatchEpisodeEntity_1.WatchEpisodeEntity(self, entopts);
    }
    ...
    WatchPromo(entopts) {
        const self = this;
        return new WatchPromoEntity_1.WatchPromoEntity(self, entopts);
    }
...
exports.JikanRestSDK = JikanRestSDK;
const SDK = JikanRestSDK;
exports.SDK = SDK;
//# sourceMappingURL=JikanRestSDK.js.map