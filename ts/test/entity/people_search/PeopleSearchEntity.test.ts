...
describe('PeopleSearchEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'people_search.' + op, live)) return
    }
    ...
    const people_search_ref01_list = await people_search_ref01_ent.list(people_search_ref01_match)
