...
//     (\`new JikanRestSDK(...)\` / \`JikanRestSDK.test(...)\` become
//     \`JikanRestSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"anime":{"test01":{"id":"test01"}},"character":{"test01":{"id":"test01"}},"club":{"test01":{"id":"test01"}},"external":{"test01":{"id":"test01"}},"genre":{"test01":{"id":"test01"}},"magazine":{"test01":{"id":"test01"}},"manga":{"test01":{"id":"test01"}},"people_search":{"test01":{"id":"test01"}},"person":{"test01":{"id":"test01"}},"producer":{"test01":{"id":"test01"}},"random":{"test01":{"id":"test01"}},"recommendation":{"test01":{"id":"test01"}},"review":{"test01":{"id":"test01"}},"schedule":{"test01":{"id":"test01"}},"season":{"test01":{"id":"test01"}},"top":{"test01":{"id":"test01"}},"user":{"test01":{"id":"test01"}},"user_about":{"test01":{"id":"test01"}},"user_club":{"test01":{"id":"test01"}},"user_friend":{"test01":{"id":"test01"}},"user_history":{"test01":{"id":"test01"}},"user_statistic":{"test01":{"id":"test01"}},"user_update":{"test01":{"id":"test01"}},"watch_episode":{"test01":{"id":"test01"}},"watch_promo":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new JikanRestSDK(...)\` and any
// \`JikanRestSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+JikanRestSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/JikanRestSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
