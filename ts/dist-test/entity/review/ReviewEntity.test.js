...
(0, node_test_1.describe)('ReviewEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'review.' + op, live))
                return;
        }
        ...
        let review_ref01_data = Object.values(setup.data.existing.review)[0];
        // LOAD
        const review_ref01_ent = client.Review();
        const review_ref01_match_dt0 = {};
        const review_ref01_data_dt0 = (await review_ref01_ent.load(review_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != review_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/review/ReviewTestData.json');
    ...
    let idmap = transform(['review01', 'review02', 'review03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['JIKAN_REST_TEST_REVIEW_ENTID'];
...
//# sourceMappingURL=ReviewEntity.test.js.map