...
(0, node_test_1.describe)('ReviewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-review', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-review', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_REVIEW_ENTID'];
...
//# sourceMappingURL=ReviewDirect.test.js.map