...
(0, node_test_1.describe)('UserHistoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let user_history_ref01_data = Object.values(setup.data.existing.user_history)[0];
        // LIST
        const user_history_ref01_ent = client.UserHistory();
        const user_history_ref01_match = {};
        user_history_ref01_match['username'] = setup.idmap['username01'];
        const user_history_ref01_list = (await user_history_ref01_ent.list(user_history_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_history/UserHistoryTestData.json');
    ...
    let idmap = transform(['user_history01', 'user_history02', 'user_history03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserHistoryEntity.test.js.map