...
(0, node_test_1.describe)('UserHistoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-user_history', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_history', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_USER_HISTORY_ENTID'];
...
//# sourceMappingURL=UserHistoryDirect.test.js.map