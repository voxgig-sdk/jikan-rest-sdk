...
(0, node_test_1.describe)('UserFriendDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-user_friend', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_friend', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_USER_FRIEND_ENTID'];
...
//# sourceMappingURL=UserFriendDirect.test.js.map