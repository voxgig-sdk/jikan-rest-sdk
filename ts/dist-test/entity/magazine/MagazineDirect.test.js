...
(0, node_test_1.describe)('MagazineDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-magazine', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-magazine', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_MAGAZINE_ENTID'];
...
//# sourceMappingURL=MagazineDirect.test.js.map