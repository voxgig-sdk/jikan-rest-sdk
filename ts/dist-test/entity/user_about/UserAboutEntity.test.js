...
(0, node_test_1.describe)('UserAboutEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_about/UserAboutTestData.json');
    ...
    let idmap = transform(['user_about01', 'user_about02', 'user_about03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['JIKAN_REST_TEST_USER_ABOUT_ENTID'];
    const live = 'TRUE' === env.JIKAN_REST_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['JIKAN_REST_TEST_USER_ABOUT_ENTID'];
...
//# sourceMappingURL=UserAboutEntity.test.js.map