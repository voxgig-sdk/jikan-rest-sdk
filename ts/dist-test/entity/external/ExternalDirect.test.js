...
(0, node_test_1.describe)('ExternalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-external', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-external', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'JIKAN_REST_TEST_EXTERNAL_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_EXTERNAL_ENTID'];
...
//# sourceMappingURL=ExternalDirect.test.js.map