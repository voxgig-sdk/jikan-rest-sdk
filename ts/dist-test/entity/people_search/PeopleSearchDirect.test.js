...
(0, node_test_1.describe)('PeopleSearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-people_search', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-people_search', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_PEOPLE_SEARCH_ENTID'];
...
//# sourceMappingURL=PeopleSearchDirect.test.js.map