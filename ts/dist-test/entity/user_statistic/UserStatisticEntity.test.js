...
(0, node_test_1.describe)('UserStatisticEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_statistic/UserStatisticTestData.json');
    ...
    let idmap = transform(['user_statistic01', 'user_statistic02', 'user_statistic03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserStatisticEntity.test.js.map