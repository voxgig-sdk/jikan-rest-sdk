...
(0, node_test_1.describe)('UserStatisticDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-user_statistic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_statistic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_USER_STATISTIC_ENTID'];
...
//# sourceMappingURL=UserStatisticDirect.test.js.map