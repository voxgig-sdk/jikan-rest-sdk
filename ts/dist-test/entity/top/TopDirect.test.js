...
(0, node_test_1.describe)('TopDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-top', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-top', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_TOP_ENTID'];
...
//# sourceMappingURL=TopDirect.test.js.map