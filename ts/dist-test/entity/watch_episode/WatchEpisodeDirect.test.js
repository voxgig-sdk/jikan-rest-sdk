...
(0, node_test_1.describe)('WatchEpisodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-watch_episode', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-watch_episode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JIKAN_REST_TEST_WATCH_EPISODE_ENTID'];
...
//# sourceMappingURL=WatchEpisodeDirect.test.js.map