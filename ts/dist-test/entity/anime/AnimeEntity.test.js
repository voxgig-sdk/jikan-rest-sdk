...
(0, node_test_1.describe)('AnimeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(anime_ref01_data_dt0.id === anime_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['anime01', 'anime02', 'anime03', 'episode01', 'episode02', 'episode03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['JIKAN_REST_TEST_ANIME_ENTID'];
    ...
    idmap = env['JIKAN_REST_TEST_ANIME_ENTID'];
