...
function envOverride(m) {
    if ('TRUE' === process.env.JIKAN_REST_TEST_LIVE ||
        'TRUE' === process.env.JIKAN_REST_TEST_OVERRIDE) {
    ...
    m.JIKAN_REST_TEST_EXPLAIN = process.env.JIKAN_REST_TEST_EXPLAIN || m.JIKAN_REST_TEST_EXPLAIN;
    return m;
}
