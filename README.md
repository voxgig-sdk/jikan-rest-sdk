...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jikan-rest` | `npm install @voxgig-sdk/jikan-rest` |
| Python | `voxgig-sdk-jikan-rest` | `pip install voxgig-sdk-jikan-rest` |
| PHP | `voxgig-sdk/jikan-rest` | `composer require voxgig-sdk/jikan-rest` |
| Golang | `github.com/voxgig-sdk/jikan-rest-sdk/go` | `go get github.com/voxgig-sdk/jikan-rest-sdk/go` |
| Ruby | `voxgig-sdk-jikan-rest` | `gem install voxgig-sdk-jikan-rest` |
| Lua | `voxgig-sdk-jikan-rest` | `luarocks install voxgig-sdk-jikan-rest` |
