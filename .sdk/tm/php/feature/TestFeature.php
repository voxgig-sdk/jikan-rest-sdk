...
// JikanRest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class JikanRestTestFeature extends JikanRestBaseFeature
{
    ...
    public function init(JikanRestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (JikanRestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = JikanRestParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (JikanRestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(JikanRestContext $ctx, $op, $args): array
    {
