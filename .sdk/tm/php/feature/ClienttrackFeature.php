...
// JikanRest SDK clienttrack feature
...
class JikanRestClienttrackFeature extends JikanRestBaseFeature
{
    ...
    public function PostConstruct(JikanRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JikanRest-SDK';
