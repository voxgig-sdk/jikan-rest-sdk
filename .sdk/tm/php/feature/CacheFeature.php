...
class JikanRestCacheFeature extends JikanRestBaseFeature
{
    ...
    private function _through(JikanRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
