...
class JikanRestGraphql
{
    ...
    // equivalent.
    public static function body(JikanRestContext $ctx): mixed
    {
    ...
    public static function errors(JikanRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
