...
// JikanRest SDK utility: fetcher

class JikanRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JikanRestSDK/1.0)';
    ...
    public static function call(JikanRestContext $ctx, string $fullurl, array $fetchdef): array
    {
