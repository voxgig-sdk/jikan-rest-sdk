...
|---|---|---|
| `ts/` | @voxgig-sdk/jikan-rest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jikan-rest-sdk \
      --repository voxgig-sdk/jikan-rest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jikan-rest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jikan-rest-sdk --id=<id>` removes it.
