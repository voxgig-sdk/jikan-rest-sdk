...
class UserAboutEntity
  ...
  def make
    opts = @_entopts.dup
    UserAboutEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [UserAboutListMatch, Hash, nil] match filter (any subset of
  #   UserAbout fields); defaults to nil, treated as an empty match that lists all.
