...
class SeasonEntity
  ...
  #
  # @param reqmatch [SeasonLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Season.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Season, Hash] the loaded Season; raises JikanRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Season>, Array] the matching Season items; raises JikanRestError on failure
