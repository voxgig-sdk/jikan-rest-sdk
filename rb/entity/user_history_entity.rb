...
class UserHistoryEntity
  ...
  def make
    opts = @_entopts.dup
    UserHistoryEntity.new(@_client, opts)
  end
  ...
  # @return [UserHistory, Hash] the current UserHistory data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserHistory fields)
  def match_get
  ...
  #
  # @param reqmatch [UserHistoryListMatch, Hash, nil] match filter (any subset of
  #   UserHistory fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UserHistory>, Array] the matching UserHistory items; raises JikanRestError on failure
