...
class RecommendationEntity
  ...
  def make
    opts = @_entopts.dup
    RecommendationEntity.new(@_client, opts)
  end
  ...
  # @return [Recommendation, Hash] the current Recommendation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Recommendation fields)
  def match_get
  ...
  #
  # @param reqmatch [RecommendationListMatch, Hash, nil] match filter (any subset of
  #   Recommendation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Recommendation>, Array] the matching Recommendation items; raises JikanRestError on failure
