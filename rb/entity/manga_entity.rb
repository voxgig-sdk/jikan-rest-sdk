...
class MangaEntity
  ...
  #   as an empty match, so client.Manga.load works with no args).
  ...
  #
  # @param reqmatch [MangaListMatch, Hash, nil] match filter (any subset of
  #   Manga fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
