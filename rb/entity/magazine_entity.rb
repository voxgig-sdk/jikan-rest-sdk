...
class MagazineEntity
  ...
  def make
    opts = @_entopts.dup
    MagazineEntity.new(@_client, opts)
  end
  ...
  # @return [Magazine, Hash] the current Magazine data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Magazine fields)
  def match_get
  ...
  #
  # @param reqmatch [MagazineListMatch, Hash, nil] match filter (any subset of
  #   Magazine fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Magazine>, Array] the matching Magazine items; raises JikanRestError on failure
