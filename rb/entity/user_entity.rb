...
class UserEntity
  ...
  # @return [User, Hash] the loaded User; raises JikanRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<User>, Array] the matching User items; raises JikanRestError on failure
