...
class ExternalEntity
  ...
  def make
    opts = @_entopts.dup
    ExternalEntity.new(@_client, opts)
  end
  ...
  # @return [External, Hash] the current External data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of External fields)
  def match_get
  ...
  #
  # @param reqmatch [ExternalListMatch, Hash, nil] match filter (any subset of
  #   External fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<External>, Array] the matching External items; raises JikanRestError on failure
