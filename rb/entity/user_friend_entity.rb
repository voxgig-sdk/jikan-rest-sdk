...
class UserFriendEntity
  ...
  def make
    opts = @_entopts.dup
    UserFriendEntity.new(@_client, opts)
  end
  ...
  # @return [UserFriend, Hash] the current UserFriend data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserFriend fields)
  def match_get
  ...
  #
  # @param reqmatch [UserFriendListMatch, Hash, nil] match filter (any subset of
  #   UserFriend fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UserFriend>, Array] the matching UserFriend items; raises JikanRestError on failure
