...
class WatchEpisodeEntity
  ...
  def make
    opts = @_entopts.dup
    WatchEpisodeEntity.new(@_client, opts)
  end
  ...
  # @return [WatchEpisode, Hash] the current WatchEpisode data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WatchEpisode fields)
  def match_get
  ...
  #
  # @param reqmatch [WatchEpisodeListMatch, Hash, nil] match filter (any subset of
  #   WatchEpisode fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WatchEpisode>, Array] the matching WatchEpisode items; raises JikanRestError on failure
