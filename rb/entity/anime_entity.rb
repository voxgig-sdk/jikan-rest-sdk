...
class AnimeEntity
  ...
  # @return [Anime, Hash] the loaded Anime; raises JikanRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Anime>, Array] the matching Anime items; raises JikanRestError on failure
