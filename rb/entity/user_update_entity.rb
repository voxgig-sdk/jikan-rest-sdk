...
class UserUpdateEntity
  ...
  def make
    opts = @_entopts.dup
    UserUpdateEntity.new(@_client, opts)
  end
  ...
  # @return [UserUpdate, Hash] the current UserUpdate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserUpdate fields)
  def match_get
  ...
  #
  # @param reqmatch [UserUpdateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UserUpdate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserUpdate, Hash] the loaded UserUpdate; raises JikanRestError on failure
