...
class PersonEntity
  ...
  # @return [Person, Hash] the loaded Person; raises JikanRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Person>, Array] the matching Person items; raises JikanRestError on failure
