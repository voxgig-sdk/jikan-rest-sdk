...
class WatchPromoEntity
  ...
  def make
    opts = @_entopts.dup
    WatchPromoEntity.new(@_client, opts)
  end
  ...
  # @return [WatchPromo, Hash] the current WatchPromo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WatchPromo fields)
  def match_get
  ...
  #
  # @param reqmatch [WatchPromoListMatch, Hash, nil] match filter (any subset of
  #   WatchPromo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WatchPromo>, Array] the matching WatchPromo items; raises JikanRestError on failure
