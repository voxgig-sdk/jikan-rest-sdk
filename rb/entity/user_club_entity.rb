...
class UserClubEntity
  ...
  def make
    opts = @_entopts.dup
    UserClubEntity.new(@_client, opts)
  end
  ...
  # @return [UserClub, Hash] the current UserClub data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserClub fields)
  def match_get
  ...
  #
  # @param reqmatch [UserClubListMatch, Hash, nil] match filter (any subset of
  #   UserClub fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UserClub>, Array] the matching UserClub items; raises JikanRestError on failure
