...
class PeopleSearchEntity
  ...
  def make
    opts = @_entopts.dup
    PeopleSearchEntity.new(@_client, opts)
  end
  ...
  # @return [PeopleSearch, Hash] the current PeopleSearch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PeopleSearch fields)
  def match_get
  ...
  #
  # @param reqmatch [PeopleSearchListMatch, Hash, nil] match filter (any subset of
  #   PeopleSearch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PeopleSearch>, Array] the matching PeopleSearch items; raises JikanRestError on failure
